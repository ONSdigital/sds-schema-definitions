...
| `items.items[]`                      | The data about each item.                                                                                                                                                                        | Yes       |
| `items.items[].identifier`           | The unique top-level identifier. For business surveys this is the reporting unit reference without the check letter appended.                                                                    | Yes       |
| `items.items[].supplier_number`      | Like ruref, this is also a unique top-level identifier for the business.                                                                                                                         | Yes       |
