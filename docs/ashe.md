...
| `items.employee[].identifier`                        | The unique person level identifier that the ONS produces (up to 7 chars) and check letter associated with the serial number                            | Yes       |
